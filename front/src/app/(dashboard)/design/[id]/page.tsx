    ...
    <div className="flex-1 flex flex-col h-full overflow-hidden bg-white text-gray-800">
      ...
      <div className="flex-1 flex min-h-0">
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-gray-200">
          {/* Canvas header */}
          <div className="h-8 flex items-center justify-between px-3 border-b border-gray-255 bg-gray-100 shrink-0">
            <div className="flex items-center gap-2 text-[10px] text-gray-500 font-semibold">
              <span className="material-symbols-outlined text-[13px] text-red-655">picture_as_pdf</span>
              <span>2D Drawing Preview</span>
              {activeDoc?.loc2D
                ? <span className="text-[9px] text-green-600 font-bold">● FILE TERSEDIA</span>
                : <span className="text-[9px] text-red-500 font-bold">● TIDAK ADA FILE</span>
              }
            </div>
          </div>

          {/* Canvas content */}
          <div className="flex-1 flex items-stretch min-h-0 bg-gray-100">
            {activeDoc?.loc2D ? (() => {
              ...
              <div className="flex-1 flex flex-col items-center justify-center gap-3">
                ...
                <p className="text-xs text-gray-550 font-medium">File PDF 2D Drawing belum diunggah untuk item ini.</p>
                <Link
                  href={`/update-design`}
